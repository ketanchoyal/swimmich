...
```
### AC-3104 [type: new]
Assertion: InvitePartnerSheet expose TextField email + UserSearchView link + CTA Invite disabled si email vide. (Pas de handler `.onOpenURL` : le callback OAuth est capturé par `ASWebAuthenticationSession`.)
